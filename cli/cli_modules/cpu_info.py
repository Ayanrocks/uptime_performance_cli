...
def display_linux():
    ...
    for i in cpu_freq:
        ...
        print(ut.colored_string("Current: ", 91) + str(math.floor(i[0])) + "MHz")
    ...
    print(ut.colored_string("sof_interrupts: ",91) + str(cpu_stats[2]))
...
def display_windows():
    ...
    print(ut.colored_string("interrupt: ", 91) + str(cpu_times_percent[3]) + "%")
    print(ut.colored_string("dpc: ", 91) + str(cpu_times_percent[4]) + "%")
    
    print(ut.colored_string("\nCPU frequency --\n", 94))
    print(ut.colored_string("Current: ", 91) + str(math.floor(cpu_freq[0])) + "MHz")
    print(ut.colored_string("Min: ", 91) + str(math.floor(cpu_freq[1])) + "MHz")
    print(ut.colored_string("Max: ", 91) + str(math.floor(cpu_freq[2])) + "MHz")
